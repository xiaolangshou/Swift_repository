...
extension FMDatabase {
    ...
    func dateForQuery(sql: String, _ values: AnyObject...) -> NSDate! {
        return valueForQuery(sql: sql, values: values) { $0.date(forColumnIndex: 0) }! as NSDate
    }
    ...
    func dataForQuery(sql: String, _ values: AnyObject...) -> NSData! {
        return valueForQuery(sql: sql, values: values) { $0.data(forColumnIndex: 0) }! as NSData
    }
}
