...
//    NSLog(@"解码后的信息%@",info_ns);
    ...
    // 推流
    [[LBffmpegTool sharedInstance] pushFlow:@"resource.bundle/war3end.mp4" output_str:@"rtmp://weelinktech.xyz/live/lt?txSecret=26ba5e91edc4d7e98ac7b333c98344ef&txTime=5F48A725"];
    // FFmpeg获取摄像头设备
